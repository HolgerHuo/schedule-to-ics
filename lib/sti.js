...
const generateEvents = (data, options) => {
        ...
        const parseCourse = (input) => {
            ...
            try {
                if (data.info.subClass === true) {
                    ...
                    course = mapCourse(mappings[input], 0);
                }
            } catch {
    ...
    extras.forEach(i => {
        ...
        const overwrites = i.overwrites ? {teachers: i.overwrites.teachers || null, mappings: i.overwrites.mappings || null, classOverwrites:  i.overwrites.classes && i.overwrites.classes[options.class] ? i.overwrites.classes[options.class] : {}} : {}
